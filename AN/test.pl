...
my @methods=(
	...
	"_get_hash_reference", 
	"_io_handle_loaded", 
	"_is_net_dbus_exporter_loadable",
	"_is_net_dbus_object_loadable", 
	"_load_fcntl",
	"_load_io_handle", 
	"_load_math_bigint", 
	"_load_net_dbus", 
	"_load_net_dbus_reactor", 
	"_load_net_dbus_remoteobject", 
	"_load_net_dbus_remoteservice", 
	"_load_net_dbus_service", 
	"_make_hash_reference", 
	"_math_bigint_loaded", 
	"_net_dbus_exporter_loaded", 
	"_net_dbus_loaded", 
	"_net_dbus_object_loaded", 
	"_net_dbus_reactor_loaded", 
	"_net_dbus_remoteobject_loaded", 
	"_net_dbus_remoteservice_loaded", 
	"_net_dbus_service_loaded", 
);
