...
sub get
{
	...
	if (ref($hash->{words}{lang}{$lang}) ne "HASH")
	{
		$an->Alert->error({
			...
			message	=>	"The 'AN::Tools::String' module's 'get' method was passed an invalid 'language' argument: [$lang]. This must match one of the languages in the words file's <langs>...</langs> block.\n",
			code	=>	17,
			file	=>	"$THIS_FILE",
			line	=>	__LINE__
		});
