...
This is the short title (title key, eventually) of the error message.

=head4 C<message>

This is the full error message (text key, eventually) of the warning message.
...
The 'AN::Tools' module tried to load the 'Net::DBus' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.

=head2 C<37>

The 'AN::Tools' module tried to load the 'Net::DBus::Service' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.

=head2 C<38>

The 'AN::Tools' module tried to load the 'Net::DBus::Reactor' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.

=head2 C<39>

The 'AN::Tools' module tried to load the 'Net::DBus::RemoteService' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.

=head2 C<40>

The 'AN::Tools' module tried to load the 'Net::DBus::Object' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.

=head2 C<41>

The 'AN::Tools' module tried to load the 'Net::DBus::RemoteObject' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.

=head2 C<42>

The 'AN::Tools' module tried to load the 'Net::DBus::Exporter' module but it failed to load or was not found. This module is needed by AN::Tools to run the logging server, send messages to be logged and other functions.
